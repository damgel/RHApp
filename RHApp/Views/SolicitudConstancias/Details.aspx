<%@ Page Title="SolicitudConstancia Details" Language="C#" MasterPageFile="~/Site.Master" CodeBehind="Details.aspx.cs" Inherits="RHApp.Views.SolicitudConstancias.Details" %>
<asp:Content runat="server" ContentPlaceHolderID="MainContent">
    <div>
        ...
        <asp:FormView runat="server"
            ...
            <EmptyDataTemplate>
                No se pudo encontrar SolicitudConstancia with idSolicitudConstancia <%: Request.QueryString["idSolicitudConstancia"] %>
            </EmptyDataTemplate>
            <ItemTemplate>
                <fieldset class="form-horizontal">
                    <legend>SolicitudConstancia Details</legend>
							<div class="row">
