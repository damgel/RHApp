<%@ Page Title="CategoriaSugerencia Details" Language="C#" MasterPageFile="~/Site.Master" CodeBehind="Details.aspx.cs" Inherits="RHApp.Views.CategoriaSugerencias.Details" %>
<asp:Content runat="server" ContentPlaceHolderID="MainContent">
    <div>
        ...
        <asp:FormView runat="server"
            ...
            <EmptyDataTemplate>
                No se pudo encontrar CategoriaSugerencia con idCategoriaSugerencia <%: Request.QueryString["idCategoriaSugerencia"] %>
            </EmptyDataTemplate>
            <ItemTemplate>
