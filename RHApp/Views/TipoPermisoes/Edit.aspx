<%@ Page Title="TipoPermisoEdit" Language="C#" MasterPageFile="~/Site.Master" CodeBehind="Edit.aspx.cs" Inherits="RHApp.Views.TipoPermisoes.Edit" %>
<asp:Content runat="server" ContentPlaceHolderID="MainContent">
    <div>
		<p>&nbsp;</p>
        <asp:FormView runat="server"
            ItemType="RHApp.DatabaseModel.TipoPermiso" DefaultMode="Edit" DataKeyNames="idTipoPermiso"
            ...
            <EditItemTemplate>
                <fieldset class="form-horizontal">
                    <legend>Editar TipoPermiso</legend>
