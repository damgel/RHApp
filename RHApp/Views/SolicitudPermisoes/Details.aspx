<%@ Page Title="SolicitudPermiso Details" Language="C#" MasterPageFile="~/Site.Master" CodeBehind="Details.aspx.cs" Inherits="RHApp.Views.SolicitudPermisoes.Details" %>
<asp:Content runat="server" ContentPlaceHolderID="MainContent">
    <div>
        ...
        <asp:FormView runat="server"
            ...
            <EmptyDataTemplate>
                No se pudo encontrar SolicitudPermiso con idSolicitudPermiso <%: Request.QueryString["idSolicitudPermiso"] %>
            </EmptyDataTemplate>
            <ItemTemplate>
