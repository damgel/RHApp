<%@ Page Title="EscalonamientoVacacioneEdit" Language="C#" MasterPageFile="~/Site.Master" CodeBehind="Edit.aspx.cs" Inherits="RHApp.Privado.EscalonamientoVacaciones.Edit" %>
<asp:Content runat="server" ContentPlaceHolderID="MainContent">
    <div>
		<p>&nbsp;</p>
        <asp:FormView runat="server"
            ItemType="RHApp.Models.EscalonamientoVacacione" DefaultMode="Edit" DataKeyNames="idEscalonamientoVacaciones"
            ...
            <EditItemTemplate>
                <fieldset class="form-horizontal">
                    <legend>Edit EscalonamientoVacacione</legend>
