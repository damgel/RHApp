<%@ Page Title="BuzonSugerenciaDelete" Language="C#" MasterPageFile="~/Site.Master" CodeBehind="Delete.aspx.cs" Inherits="RHApp.Privado.BuzonSugerencias.Delete" %>
<asp:Content runat="server" ContentPlaceHolderID="MainContent">
    <div>
		<p>&nbsp;</p>
        <h3>Estas seguro que deseas eliminar este  BuzonSugerencia?</h3>
        <asp:FormView runat="server"
            ItemType="RHApp.Models.BuzonSugerencia" DataKeyNames="idBuzonSugerencia"
            ...
            <ItemTemplate>
                <fieldset class="form-horizontal">
                    <legend>Eliminar BuzonSugerencia</legend>
							<div class="row">
