<%@ Page Title="Empleado Details" Language="C#" MasterPageFile="~/Site.Master" CodeBehind="Details.aspx.cs" Inherits="RHApp.Privado.Empleados.Details" %>
        ...
        <asp:FormView runat="server"
            ...
            <ItemTemplate>
                <fieldset class="form-horizontal">
                    <legend>Empleado Details</legend>
							<div class="row">
