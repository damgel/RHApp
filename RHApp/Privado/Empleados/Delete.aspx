<%@ Page Title="EmpleadoDelete" Language="C#" MasterPageFile="~/Site.Master" CodeBehind="Delete.aspx.cs" Inherits="RHApp.Privado.Empleados.Delete" %>
<asp:Content runat="server" ContentPlaceHolderID="MainContent">
    <div>
		<p>&nbsp;</p>
        <h3>Estas seguro que deseas eliminar este  Empleado?</h3>
        <asp:FormView runat="server"
            ItemType="RHApp.Models.Empleado" DataKeyNames="idEmpleado"
