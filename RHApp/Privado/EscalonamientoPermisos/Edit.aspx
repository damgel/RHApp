<%@ Page Title="EscalonamientoPermisoEdit" Language="C#" MasterPageFile="~/Site.Master" CodeBehind="Edit.aspx.cs" Inherits="RHApp.Privado.EscalonamientoPermisos.Edit" %>
<asp:Content runat="server" ContentPlaceHolderID="MainContent">
    <div>
		<p>&nbsp;</p>
        <asp:FormView runat="server"
            ItemType="RHApp.Models.EscalonamientoPermiso" DefaultMode="Edit" DataKeyNames="idEscalonamientoPermisos"
