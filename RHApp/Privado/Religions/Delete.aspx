<%@ Page Title="ReligionDelete" Language="C#" MasterPageFile="~/Site.Master" CodeBehind="Delete.aspx.cs" Inherits="RHApp.Privado.Religions.Delete" %>
<asp:Content runat="server" ContentPlaceHolderID="MainContent">
    <div>
		<p>&nbsp;</p>
        <h3>Estas seguro que deseas eliminar este  Religion?</h3>
        <asp:FormView runat="server"
            ItemType="RHApp.Models.Religion" DataKeyNames="idReligion"
